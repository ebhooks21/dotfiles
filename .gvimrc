...
set runtimepath^=~/.vim/plugin/tagbar-javascript.vim
...
"set guifont=OverpassMono\ Nerd\ Font\ Mono:h7:cANSI:qDRAFT
set guifont=OverpassMono\ Nerd\ Font\ Mono\ Regular\ 7
